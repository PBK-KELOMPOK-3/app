              ...
              <form>
                  ...
                  <div class="mb-3">
                    ...
                    <ul class="nav justify-content-start list-unstyled d-flex">
                      <li class="ms-3"><a class="text-muted" href="#"><svg class="bi" width="48" height="48"><use xlink:href="#google"/></svg></a></li>
                      <li class="ms-3"><a class="text-muted" href="#"><svg class="bi" width="48" height="48"><use xlink:href="#facebook"/></svg></a></li>
                    </ul>
                  </div>
                </form>
            </div>
